...
class ConversationEngine:
    ...
    def _generate_reply(
        ...
        if (decision.task_action or decision.gmail_action or decision.event_action) is not None and self._actions is not None:
    ...
    def _carry_out_action(self, decision: AgentDecision, session: ConversationSession) -> str:
        ...
        action = decision.task_action or decision.gmail_action or decision.event_action
